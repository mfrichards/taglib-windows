...
TAGLIB_C_EXPORT TagLib_ID3v2Tag *taglib_flac_id3v2(TagLib_File *file);
TAGLIB_C_EXPORT TagLib_ID3v2Tag *taglib_wav_id3v2(TagLib_File *file);
TAGLIB_C_EXPORT TagLib_ID3v2Tag *taglib_aiff_id3v2(TagLib_File *file);
...
TAGLIB_C_EXPORT TagLib_APETag *taglib_ape_ape(TagLib_File *file);
...
TAGLIB_C_EXPORT UINT taglib_ape_item_binary(const TagLib_APEItem *item, char *buf, UINT max);
...
/*** FLAC artwork ***/
TAGLIB_C_EXPORT UINT taglib_flac_artwork(TagLib_File *file, char *buf, UINT max);
